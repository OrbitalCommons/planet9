...
"""
import numpy as np
from manim import Create, DOWN, FadeIn, RIGHT, Scene, UP, VGroup, Write, rate_functions, ValueTracker, always_redraw
...
class OortSelfgrav2024(Scene):
    def construct(self):
        ...
        live = always_redraw(lambda: VGroup(*[
            ...
            for v in varpis0]))
        self.add(live)
        clbl = layout.label("collective self-gravity → coherent precession", font_size=17, color=P.TEAL).to_edge(UP, buff=1.5)

...
class NeptuneCrossing2024(Scene):
    def construct(self):
        ...
        self.add(layout.label("Neptune", font_size=14, color=P.BLUE).next_to(neptune, DOWN, buff=0.05))
        ...
        self.add(layout.label("perihelion crosses Neptune", font_size=15, color=P.RED).to_edge(DOWN, buff=1.5))
